...
FONT_JP = FONT_CJK
FONT_JP_BOLD = FONT_CJK_BOLD
FONT_SERIF = "TimesNewRoman"
FONT_SERIF_BOLD = "TimesNewRomanBold"
...
def register_fonts() -> None:
    font_specs = [
        (FONT_CJK, "/System/Library/Fonts/Supplemental/Songti.ttc", 6),
        (FONT_CJK_BOLD, "/System/Library/Fonts/STHeiti Medium.ttc", 0),
        (FONT_SERIF, "/System/Library/Fonts/Supplemental/Times New Roman.ttf", 0),
        (FONT_SERIF_BOLD, "/System/Library/Fonts/Supplemental/Times New Roman Bold.ttf", 0),
    ]
    for name, path, subfont_index in font_specs:
